...
if __name__ == "__main__":   
    ...
    functions_frame = Frame(guiWindow, bg="skyblue")  
    functions_frame.pack(side="top", expand=True, fill="both")  
 
    task_label = Label(functions_frame,
        text="TO-DO-LIST \n Enter the Task :",  
        font=("arial", "14", "bold"),  
        background="skyblue",  
        foreground="black"
